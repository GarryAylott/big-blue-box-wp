...
?>
	...
	<main id="primary" class="site-main">
		<div class="wrapper region-large">
			<div class="hero">
				<div class="latest-podcast-ep">
					<?php
					...
					<img class="latest-podcast-ep__img rounded-small" src="<?php echo the_post_thumbnail_url('homepage-thumb'); ?>">
					...
					<div class="latest-podcast-ep__content">
						<div class="flow-small">
							<p class="bold icon-text-group clr-900">
								...
								Latest Podcast Episode • <?php the_field('episode_number'); ?>
							</p>
