    ...
    if (!empty($categories)) {
        foreach ($categories as $category) {
            if ($category->slug == 'articles') {
                echo '<div class="category-tag rounded-small"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
...
</svg> <p class="small bold">Article</p></div>';
            } elseif ($category->slug == 'podcasts') {
                echo '<div class="category-tag rounded-small"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" fill="none">
...
</svg> <p class="small bold">Podcast</p></div>';
            }
        }
    }
?>