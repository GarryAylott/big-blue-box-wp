<?php
/**
 * Big Blue Box functions and definitions
 *
...
function bigbluebox_setup() {
	/*
		...
		* If you're building a theme based on Big Blue Box, use a find and replace
...
function bigbluebox_scripts() {
	...
	wp_enqueue_script( 'bigbluebox-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
