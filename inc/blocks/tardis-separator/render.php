<?php
/**
 * TARDIS Separator - Server-side rendering.
 *
...
$clip_id = wp_unique_id( 'ts-clip-' );
?>

<div class="tardis-separator" role="separator">
	<span class="tardis-separator__line"></span>
	<svg class="tardis-separator__icon" xmlns="http://www.w3.org/2000/svg" width="20" height="27" viewBox="0 0 309 421" fill="currentColor" aria-hidden="true">
