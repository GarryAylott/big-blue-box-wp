...
<section class="brand-logos-marquee" aria-labelledby="Featured brands from the world of Doctor Who">
    <div class="brand-logos-marquee__group">
        <picture class="brand-logo-1">
            ...
            <img src="<?php echo get_bloginfo('template_url') ?>/images/TARDIS-busted.webp" loading="eager" alt="Doctor Who">
        </picture>
        <picture class="brand-logo-3">
            ...
            <img src="<?php echo get_bloginfo('template_url') ?>/images/TARDIS-busted.webp" loading="eager" alt="Big Finish">
        </picture>
        <picture class="brand-logo-4">
            ...
            <img src="<?php echo get_bloginfo('template_url') ?>/images/TARDIS-busted.webp" loading="eager" alt="The Sarah Jane Adventures">
        </picture>
        <picture class="brand-logo-5">
            ...
            <img src="<?php echo get_bloginfo('template_url') ?>/images/TARDIS-busted.webp" loading="eager" alt="The War Between the Land and the Sea">
        </picture>
        <picture class="brand-logo-2">
            ...
            <img src="<?php echo get_bloginfo('template_url') ?>/images/TARDIS-busted.webp" loading="eager" alt="Torchwood">
        </picture>
        <picture class="brand-logo-6">
            ...
            <img src="<?php echo get_bloginfo('template_url') ?>/images/TARDIS-busted.webp" loading="eager" alt="Class">
        </picture>
    </div>
</section>