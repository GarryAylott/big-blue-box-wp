                ...
                while ($query1->have_posts()) : $query1->the_post(); ?>
                    ...
                    <?php if (has_post_thumbnail()) : ?>
                        <a href="<?php the_permalink(); ?>">
                            <img class="post-thumb-img latest-podcast-ep__thumb rounded-small" src="<?php echo the_post_thumbnail_url('homepage-thumb'); ?>" width="595" height="335" alt="<?php echo the_title() ?>">
                        </a>
                    <?php endif; ?>

                    <div class="latest-podcast-ep__content">
                        <div class="latest-podcast-ep__details">
                            <p class="small semi-bold icon-text-group clr-900">
                    ...
                    if ($query3->have_posts()) :
                        while ($query3->have_posts()) : $query3->the_post(); ?>
                            <article id="post-<?php the_ID(); ?>" <?php post_class('post-card-alt'); ?>>
                                ...
                                <?php if (has_post_thumbnail()) : ?>
                                    <a href="<?php the_permalink(); ?>">
                                        <img class="post-thumb-img rounded-small" src="<?php echo the_post_thumbnail_url('homepage-thumb'); ?>" width="391" height="220" alt="<?php echo the_title() ?>">
                                    </a>
                                <?php endif; ?>
                        ...
                        <?php while ($query->have_posts()) : $query->the_post(); ?>
                            ...
                            <li>
                                <div class="more-articles-content">
                                    <?php if (has_post_thumbnail()) : ?>
                                    <a href="<?php the_permalink(); ?>">
                                        <img class="post-thumb-img-small rounded-xs" src="<?php echo the_post_thumbnail_url('homepage-thumb'); ?>" width="156" height="88" alt="<?php echo the_title() ?>">
                                    </a>
                                    <?php endif; ?>
