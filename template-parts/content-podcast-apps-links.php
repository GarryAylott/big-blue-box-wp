...
<ul class="podcast-app-links__links" role="list">
    ...
    <li class="app">
        <a class="has-external-icon text-button" href="https://lnkfi.re/bigblueboxpodcast" target="_blank" rel="noopener noreferrer">
            <img src="<?php echo get_bloginfo('template_url') ?>/images/icons/icon-headphones.svg" width="16" height="16" alt="More Podcast Apps">
        <span class="small">More Podcast Apps</span>
        </a>
    </li>
</ul>